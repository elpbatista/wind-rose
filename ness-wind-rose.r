...
ggsave(filename = 'months.dirrose.png', plot = multiplot(plt.jan, plt.feb, plt.mar, plt.apr, plt.may, plt.jun, plt.jul, plt.aug, plt.sep, plt.oct, plt.nov, plt.dec, cols=4), width = 84, height = 84, units="mm", dpi = 300, type="cairo-png")
